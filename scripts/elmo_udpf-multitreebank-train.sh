...
echo "Running get-elmo-vectors.sh..."
...
echo "Output:"
ls -l ${ELMO_FILE_PREFIX}-train.hdf5 ${MODELDIR}/elmo-stderr-train.txt ${MODELDIR}/elmo-stdout-train.txt

echo "Running wrapper-elmo-hdf5-to-npz.sh..."
...
echo "Output:"
ls -l ${MODELDIR}/${ELMO_FILE_PREFIX}-train.npz
